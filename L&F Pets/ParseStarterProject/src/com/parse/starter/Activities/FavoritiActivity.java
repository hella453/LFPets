...
public class FavoritiActivity extends ActionBarActivity {
    private Toolbar toolbar;
    ViewPager pager;
    ViewPagerAdapter adapter;
    SlidingTabLayout tabs;
    CharSequence Titles[]={"Izgubljen sam", "Nađen sam"};
    int Numboftabs =2;
    String tipOglasa ="Favoriti";
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        getSupportActionBar().setTitle("   Favoriti");
